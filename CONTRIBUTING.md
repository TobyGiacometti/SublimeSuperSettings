...
- Classes/methods/functions *must* be documented using reStructuredText syntax and following template:
    ...
    ```python
    """Summary for class/method/function (if not obvious or description provided).

    Description for class/method/function (if extended documentation needed).

    :param type name: Description for method/function parameter (if needed).
    :raises type: Description for method/function exception (if needed).
    :return: Description for method/function return value (if needed).
    :rtype: type (if function returns value)
    """
    ```
